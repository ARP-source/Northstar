    ...
    <div className="flex min-h-screen bg-zinc-950">
      ...
      <aside className="w-64 border-r border-zinc-800 bg-zinc-950 flex flex-col fixed inset-y-0 z-10">
        ...
        <div className="p-4 border-t border-zinc-800/50">
          ...
          {/* Qwen Cloud Deployment Indicator */}
          <div className="flex items-center gap-2 p-2 rounded-md bg-zinc-900/50 border border-zinc-800">
            ...
            <div className="flex flex-col">
              <span className="text-[10px] text-zinc-500 font-medium uppercase tracking-wider leading-tight">Intelligence</span>
              <span className="text-xs text-zinc-300 font-medium leading-tight">Qwen Cloud API</span>
            </div>
          </div>
        </div>
      </aside>
